...
import 'package:my_devices/notification/notification_services.dart';
...
class DeviceProvider extends ChangeNotifier {
  ...
  Future<void> getDevicesFromLocalDb() async {
    try {
      List jsonList = await LocalDB().getData('devices');
      ...
      print("device provider getting data error : $e");
    }
  }
